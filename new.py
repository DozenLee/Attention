...
for w in range(10000):
    ...
    for k in range(10):
        ...
        img1_circle = cv2.circle(img_circle,(x,y),80,(random.randint(0,255),random.randint(0,255),random.randint(0,255)),-1)
    ...
    for k in range(10):
        x = random.randint(10,246)
        y = random.randint(10,246)
        imgres_circle = cv2.circle(img3_maru,(x,y),10,(random.randint(0,255),random.randint(0,255),random.randint(0,255)),-1)
 
    
    #img_withcirclenoise= cv2.cvtColor(imgres_circle, cv2.COLOR_BGR2GRAY)
    cv2.imwrite("./new/image%05d.PNG" %(w),imgres_circle)
